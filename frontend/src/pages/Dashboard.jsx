      ...
      <div className="container mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          <DashboardCard
            ...
            content={<p className="text-3xl font-bold text-blue-600 dark:text-blue-400">$1,234.56</p>}
          />
          ...
          <DashboardCard
            ...
            content={
              <>
                <p className="text-lg mb-2">You have made 5 donations in total.</p>
                <Link to="/dashboard/past-donations" className="text-blue-600 hover:text-blue-500 transition duration-300 inline-block">
                  View Past Donations → 
                </Link>
              </>
            }
          ...
          <DashboardCard
            ...
            content={
              <>
                <p className="text-lg mb-2">Manage your account settings and preferences.</p>
                <Link to="/dashboard/settings" className="text-blue-600 hover:text-blue-500 transition duration-300 inline-block">
                  Go to Settings → 
                </Link>
              </>
            }
  ...
  <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
    <div className="relative scrollbar-none bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-md max-h-full overflow-y-auto shadow-xl">
      ...
      <DonationForm />
        ...
        {/* User Donation List */}
        <div className="mt-12">
          <h2 className="text-2xl font-bold mb-4 text-center">Your Donation History</h2>
          <UserDonationList />
        </div>
      </div>
    </div>
